...
return array(
//网站路径
'web_path' => '/phpcmsv9/phpsso_server/',
//Session配置
...
'cookie_pre' => 'ZVmbI_', //Cookie 前缀，同一域名下安装多套系统时，请修改Cookie前缀
'cookie_ttl' => 0, //Cookie 生命周期，0 表示随浏览器进程

'js_path' => 'http://localhost/phpcmsv9/phpsso_server/statics/js/', //CDN JS
'css_path' => 'http://localhost/phpcmsv9/phpsso_server/statics/css/', //CDN CSS
'img_path' => 'http://localhost/phpcmsv9/phpsso_server/statics/images/', //CDN img
'upload_path' => PHPCMS_PATH.'uploadfile/', //上传文件路径
'app_path' => 'http://localhost/phpcmsv9/phpsso_server/',//动态域名配置地址
...
'errorlog' => 0, //是否保存错误日志
'gzip' => 1, //是否Gzip压缩后输出
'auth_key' => 'wH57V9MsZvRCIN6Hugh7', // //Cookie密钥
'lang' => 'zh-cn',  //网站语言包
